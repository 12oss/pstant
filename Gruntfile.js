	...
	grunt.initConfig({
		...
		concat: {
			css: {
				...
				dest: '_gh_pages/dist/css/pstant.css'
			},
			js: {
				options: {
					separator: ';',
				...
				dest: '_gh_pages/dist/js/pstant.js'
			}
		},
		cssmin: {
			css: {
				src: '_gh_pages/dist/css/pstant.css',
				dest: '_gh_pages/dist/css/min/pstant.min.css'
			}
		},
		uglify: {
			js: {
				src: '_gh_pages/dist/js/pstant.js',
				dest: '_gh_pages/dist/js/min/pstant.min.js'
			}
		},
		watch: {
			css: {
